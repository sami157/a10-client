    ...
    return (
        <div className="md:w-3/5 mx-auto my-4">
            <div className="carousel rounded-lg">
                <div id="slide1" className="carousel-item relative w-full flex flex-col md:justify-center bg-white/50 glass h-60 md:h-100">
                ...
                <div id="slide2" className="carousel-item relative w-full flex flex-col md:justify-center bg-white/50 glass">
                ...
                <div id="slide3" className="carousel-item relative w-full flex flex-col md:justify-center bg-white/50 glass">
                    <p className="md:p-10 p-4 text-center md:text-2xl md:mb-0 mb-10">
